...
namespace ContactProvider
{
    public class GoogleProvider : IContactProvider
    {
        ...
        private string certificatePath = ConfigurationManager.AppSettings["Resources_Path"] + "/Certificades/myrsacert.pfx";
        ...
        {
            X509Certificate2 cert = new X509Certificate2(certificatePath, "jody23a");
