...
namespace FashionAde.Data.Repository
{
    public class ClosetRepository : Repository<Closet>, IClosetRepository
    {
        ...
        #region Closet Creation Process

        public int GetBestEditorRatedClosetOutfitId(int closetId)
        {
            string query = string.Format("call uspFindBestRatedClosetOutfit({0});", closetId);
        ...
        {
            string query = "LOAD DATA INFILE '{0}' IGNORE INTO TABLE proc_closetoutfits ";
