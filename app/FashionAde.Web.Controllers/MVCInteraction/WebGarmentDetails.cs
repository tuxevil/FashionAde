...
namespace FashionAde.Web.Controllers.MVCInteraction
{
    public class WebGarmentDetails
    {
        ...
        public virtual string PurchasedOn
        {
        ...
        public virtual string IsTailored
        {
        ...
        public virtual int ClosetGarmentId
        {
            get { return closetGarmentId; }
            set { closetGarmentId = value; }
        }
