...
<div id="buildYourCloset" >
    ...
    <div class="buildClosetTitle">
        ...
        <h2 style="margin-top:-18px;">Ready to get started? First choose your style:</h2>        
    </div>
...
<span class="fashionFlavorTitle">Which type or types are most like you?</span>
    <div id="divFlavorSelect" class="flavorContainer">
        <% using (Html.BeginForm("SelectFashionFlavor", "BuildYourCloset")) {  
             if(Model != null)
                foreach (var fashionFlavor in Model) { 
                    Html.RenderPartial("FashionFlavor", fashionFlavor);
                } %>       
    </div>    
    <input id="btnBuildNext" type="image" src="../../img/BuildYourCloset/button_next.gif" value="Next" style=" clear:both; " />
     <% } %>     
</div>
...
<div class="fashionFlavors flavorRigth">
    ...
    <div class="flavorContainer"  style="float:left;">
        <a class="startQuiz" shape="rect"  href="#QuizStep1" title="Take our quiz to pinpoint your style" alt="">
            <img id="imgQuiz"  src="../../img/BuildYourCloset/img_take_our_quiz.jpg"  alt="Take Our Quiz!" class="startQuizButtonBanner" />        
        </a> 
    </div>
    <a class="startQuiz" shape="rect"  href="#QuizStep1" title="Take our quiz to pinpoint your style" alt="" style="display:inline;" >
        <img id="imgStartQuiz"  src="../../img/BuildYourCloset/button_next.gif" alt="Take Our Quiz!" class="startQuizButton" style="" />    
    </a>
</div>
...
<div id="divQuizAll">     
    <div id="QuizStep1" class="quizPopup">            
        <div class="quizHeader">            
            <img src="../../img/quiz_logo.jpg" class="quizLogo" alt="" style="" />
        ...
        <div class="quizFooter">
            <img src="../../img/BuildYourCloset/progress_step1.gif" alt="Step 1" class="quizProgress" />            
            <input id="lnkQuizStep2" type="image" href="#QuizStep2" src="../../img/BuildYourCloset/button_next.gif" value="Next" style="float:right" />
        </div>        
    </div>    
    ...
    <div id="QuizStep2" class="quizPopup" >
        ...
        <div class="quizFooter">            
            <img src="../../img/BuildYourCloset/progress_step2.gif" alt="Step 2" class="quizProgress" />
            <input id="lnkQuizStep3" type="image" href="#QuizStep3" src="../../img/BuildYourCloset/button_next.gif" value="Next" style="float:right;" />
            <input id="lnkPreviousStep1" type="image" href="#QuizStep1" src="../../img/BuildYourCloset/button_previous.gif"  style="float:right;" />
        </div>
    </div>
    ...
    <div id="QuizStep3" class="quizPopup" >
        ...
        <div class="quizFooter">
            <img src="../../img/BuildYourCloset/progress_step3.gif" alt="Step 3" class="quizProgress" />
            <input id="lnkQuizComplete" type="image" href="#QuizComplete" src="../../img/BuildYourCloset/button_next.gif" value="Next" style="float:right;" />
            <input id="lnkPreviousStep2" type="image" href="#QuizStep2" src="../../img/BuildYourCloset/button_previous.gif"  style="float:right;" />
        </div>
    ...
    <div id="QuizComplete" class="quizPopup" >
                ...
                <div class="quizCompleteBoxes" >
                    ...
                    <div class="quizCompleteWhiteSpace">
                        ...
                        <div id="Result2" class="quizCompleteResult" >
                            <img id="FashionFlavor2Image" src="" class="quizCompleteFashionFlavorImage"/><br />
        ...
        <div class="quizFooter">
            <img src="../../img/BuildYourCloset/progress_step4.gif" alt="Step 4" class="quizProgress" />
            <% using (Html.BeginForm("ContinueBuilding", "BuildYourCloset")) { %>  
            <input type="hidden" id="Flavor1Id" name="Flavor1Id" />
            <input type="hidden" id="Flavor2Id" name="Flavor2Id" />
            
            <input id="btnContinueBuilding" type="image" src="../../img/BuildYourCloset/button_finish.gif" value="Continue" style="float:right" />
            <input id="lnkRestart" type="image" href="#QuizStep1" src="../../img/BuildYourCloset/button_restart.gif"  style="float:right;" />
...
<script type="text/javascript">
    ...
    function getFashionFlavors($inputs) {
        ...
        $.ajax({
            type: "POST",
            url: "<%= Url.RouteUrl(new { controller = "BuildYourCloset", action= "GetResult"}) %>",
            data: encoded,
            ...
            success: function(data) {
                ...
                $("#Flavor1Image").val(data.FashionFlavor1Image);
                $("#FashionFlavor1Image").attr("src", resPath + "/FashionFlavors/" + data.FashionFlavor1Image);
                ...
                if (!data.Single) {
                    ...
                    $("#Flavor2Image").val(data.FashionFlavor2Image);
                    $("#FashionFlavor2Image").attr("src", resPath + "/FashionFlavors/" + data.FashionFlavor2Image);
