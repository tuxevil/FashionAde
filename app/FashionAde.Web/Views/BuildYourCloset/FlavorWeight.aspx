...
<asp:Content ID="indexContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div id="buildYourCloset" >
        <div class="buildClosetTitle">
            ...
            <h2 style="margin-top:-18px;">How important is each of these styles to you?</h2><br />
            <h2 style="margin-top:-18px;">One style must be at least 60%.</h2>
        </div>
        ...
        <div class="divBuildBottom">
            <% using (Html.BeginForm("SetWeight", "BuildYourCloset")) { %>   
            ...
            {
                List<FashionAde.Core.Accounts.UserFlavor> selectedUF = (List<FashionAde.Core.Accounts.UserFlavor>)ViewData["UserFlavorSelected"];
            ...
            <table style="width:100%;">
                <tr>
                    <td align="right">                        
                        <input id="btnPrevious" type="image" src="../../img/BuildYourCloset/button_previous2.gif" value="Previous" name="Previous" />
                    </td>
                    <td align="left"><input id="btnWhatsYourFlavor" type="image" src="../../img/BuildYourCloset/button_next.gif" value="Next" name="Next" /></td>            
                </tr>    
            </table>
