...
<title>Friends Beta Invitation</title>
</asp:Content>

<asp:Content ID="indexContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
<span class="Title">WELCOME <strong><%= HttpUtility.HtmlEncode(ViewData["userName"].ToString()) %></strong></span>
...
<asp:Content ID="friendBetaScripts" ContentPlaceHolderID="ScriptsPlaceHolder" runat="server">
