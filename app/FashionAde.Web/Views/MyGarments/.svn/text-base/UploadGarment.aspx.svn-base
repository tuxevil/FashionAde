...
<asp:Content ID="indexContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <h2 style="float: left; width: 275px; margin-top: -15px;">Get <a href="<%= Url.RouteUrl(new { controller = "MyGarments", action= "Recomendations"}) %>" style=" color:#3C3A3B; display: inline; text-decoration: underline" >recommendations</a> for taking photos of your personal garments.</h2>
    <%
        IList<FashionFlavor> flavors = (List<FashionFlavor>)ViewData["FashionFlavors"];
    %>
    <div class="GarmentSelector_FilterDiv_FashionFlavorSelected" style="display: inline; float: right; margin-right: 10px; margin-top: -50px; ">
    ...
    <% using (Html.BeginForm("UploadFile", "MyGarments", FormMethod.Post, new { enctype = "multipart/form-data" }))
    { %>     
    <div id="MyGarments_Panel1" class="MyGarments_Panel" style="height:auto; overflow:auto;">
        <div id="divUpload1" class="upload">
            ...
            <div class="fakefile">
                ...
                <img src="/img/browse.jpg" />
            </div>
            </div>
        </div>        
        <div id="divUploadInfo1" class="uploadInfo" style="display:none;">            
            <img id="uploadImage1" src="" class="uploadImage" />
            <span id="uploadName1" class="uploadName"></span>            
            <img id="uploadRemove1" src="/img/MyGarments/remove.jpg" class="uploadRemove" />
            ...
            <table class="uploadTable">
                ...
                <tr>
                    ...
                    <td style="font-size: 10px;" class="uploadPrivacy">
                        <% =Html.RadioButton("PrivacyStatus1", true, true)%> My Private Closet - only I will see it <br />
                        <% =Html.RadioButton("PrivacyStatus1", false, false)%> The Public Closet - anyone with my style type can see it                    
                    </td>
                </tr>
            </table>            
        </div> 
    ...
    <input id="btnUpload" type="image" src="/img/MyGarments/img_upload_garments.jpg" class="uploadButton"  />    
    <a href="<%= Url.RouteUrl(new { controller = "MyGarments", action= "Outfits"}) %>" class="skipLink" >
        <img id="btnSkip" src="/img/MyGarments/img_skip_view_outfits.jpg" class="skipButton" />
    </a>
    
    <img id="imgLoading" class="uploadLoading" src="../../img/MyGarments/Ajax-loader.gif" /> 
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("form").validate({
            ...
            messages: {
                ...
                "Title3": { required: "This field is required." },
                "Title4": { required: "This field is required." },
                "Title5": { required: "This field is required." }
            }
        });
    ...
    function getFileIcon(ext) {
        ...
        switch (ext) {
            case "gif":
                return "/img/UploadIcons/icon_GIF_big.png";
                
            case "jpg":
                return "/img/UploadIcons/icon_JPG_big.png";

            case "jpeg":
                return "/img/UploadIcons/icon_JPG_big.png";
                
            case "png":
                return "/img/UploadIcons/icon_PNG_big.png";

            default:
                return "/img/UploadIcons/icon_Generic_big.png";
        }
    }
