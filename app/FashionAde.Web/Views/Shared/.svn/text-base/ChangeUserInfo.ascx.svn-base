    ...
    <% using (Html.BeginForm("ChangeInfo", "Account"))
        ...
        <table style="float:left;">
            ...
            <tr>
                ...
                <td class="tdAlerts"><div id="FirstNameCheck" style="margin-top: 0px;"></div></td>
            </tr>
            <tr>
                <td>Last Name</td>
                ...
                <td class="tdAlerts"><div class="formValitationAlert" id="LastNameCheck" style="margin-top: 0px;"></div></td>
            </tr>
            <tr>
                <td>Zip Code</td>
                <td class="profileInfo"><%= Html.TextBox("ZipCode", Model.ZipCode, new { title = "Please, insert a zipcode", @class = "InputForValidate" })%> </td>
                <td class="tdAlerts"><div class="formValitationAlert" id="ZipCodeCheck" style="margin-top: 0px;"></div></td>
            </tr>
            <tr>
                <td>Size Category</td>            
                ...
                <td class="tdAlerts"><div class="formValitationAlert" id="UserSizeCheck" style="margin-top: 0px;"></div></td>
            </tr>
        </table>
        <div class="divInfo" >
        ...
        <div class="centerDiv" style="width:215px;">
            <input id="btnSaveInfo" type="image" src="../../img/buttons/btn_save_changes.gif" alt="Save My Changes" />            
        </div>
        <% } %>           
    </div>