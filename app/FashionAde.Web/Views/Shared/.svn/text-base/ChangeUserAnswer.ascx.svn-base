...
<% using (Html.BeginForm("ChangeAnswer", "Account"))
    ...
    <table style="float:left;">
        <tr>
            ...
            <td class="tdAlerts"><div class="formValitationAlert" id="SecurityQuestionCheck" style="margin-top: 0px;"></div></td>
        </tr>
        <tr>
            ...
            <td class="tdAlerts"><div class="formValitationAlert" id="SecurityAnswerCheck" style="margin-top: 0px;"></div></td>
        </tr>
        <tr>
            <td>Password</td>
            ...
            <td class="tdAlerts"><div class="formValitationAlert" id="PasswordCheck" style="margin-top: 0px;"></div></td>
        </tr>
    </table>
