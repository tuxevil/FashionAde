    ...
    <% using (Html.BeginForm("ChangeInfo", "Account"))
        ...
        <table style="float:left;">
            <tr>
                ...
                <td class="profileInfo" colspan="2"><%= HttpUtility.HtmlEncode(Model.Email) %></td>
            </tr>
            <tr>
                <td>First Name</td>            
                <td class="profileInfo"><%= Html.TextBox("FirstName", Model.FirstName, new { title = "Please, insert your first name", @class = "InputForValidate", maxlength = 100 })%> </td>
                <td class="tdAlerts"></td>
            </tr>
            <tr>
                <td>Last Name</td>
                <td class="profileInfo"><%= Html.TextBox("LastName", Model.LastName, new { title = "Please, insert your last name", @class = "InputForValidate", maxlength = 100 })%> </td>
        ...
        <div class="centerDiv" style="width:215px;">
            <div class="formButtonBig" style="float:left"><input type="submit" value="Save My Changes"/> </div>
        </div>
        <% } %>           
    </div>