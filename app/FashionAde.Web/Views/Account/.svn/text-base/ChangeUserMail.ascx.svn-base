...
<% using (Html.BeginForm("ChangeEmail", "Account"))
    ...
    <table style="float:left;">
        <tr>
            ...
            <td class="profileInfo"><%= HttpUtility.HtmlEncode(Model.Email) %></td>
        </tr>
        <tr>
    ...
    <div class="centerDiv" style="width:215px;">
        <div class="formButtonBig" style="float:left"><input id="btnEmail" type="submit" value="Save My Changes"/></div>
    </div>
    <% } %>
</div>
