...
namespace Tests.FashionAde.ApplicationServices
{
    ...
    public class OutfitEngineTest
    {
        ...
        //[Test]
        //public void CanGenerateOutfits()
        //{
        //    OutfitEngineService oes = new OutfitEngineService(CreateMockPreGarmentRepository(), CreateMockOutfitRepository(), CreateMockFashionFlavorRepository(), CreateMockEventTypeRepository(), CreateMockStyleRulesRepository());
        //    IList<Outfit> lstOutfits = oes.RunOutfitGenerator();
        //    Assert.IsFalse(lstOutfits.Count == 0, "No outfits were generated.");
        //}
        ...
        public Garment CreateGarment(PreGarment pregarment)
        {
            ...
            g.Tags.Silouhette = new Silouhette { PreSilouhette = pregarment.PreSilouhette };
        ...
        private StyleRule CreateStyleRule(FashionFlavor fv)
        {
            ...
            switch (fv.Name)
            {
                ...
                case "Romantic":
                    ...
                    sr.Shapes.Add(new ShapeRule { FromItem = ShapeType.Slim, ToItem = ShapeType.Fitted });
                    sr.Shapes.Add(new ShapeRule { FromItem = ShapeType.Slim, ToItem = ShapeType.Loose });
                    sr.Shapes.Add(new ShapeRule { FromItem = ShapeType.Fitted, ToItem = ShapeType.Loose });
                    sr.Shapes.Add(new ShapeRule { FromItem = ShapeType.Loose, ToItem = ShapeType.Slim });
                    sr.Shapes.Add(new ShapeRule { FromItem = ShapeType.Loose, ToItem = ShapeType.Fitted });
                ...
                case "Comfortable":
                    ...
                    sr.Shapes.Add(new ShapeRule { FromItem = ShapeType.Fitted, ToItem = ShapeType.Loose });
                    sr.Shapes.Add(new ShapeRule { FromItem = ShapeType.Loose, ToItem = ShapeType.Fitted });
                    sr.Shapes.Add(new ShapeRule { FromItem = ShapeType.Loose, ToItem = ShapeType.Loose });
...
//            for (int i = 1; i <= 2; i++)
        ...
        private Silouhette CreateSilouhette(string description, params LayerCode[] layerCodes)
        {
            ...
            //    sil.Layers.Add(lc);
            sil.PreSilouhette = new PreSilouhette { Layer = layerCodes[0], ShapeType = GetRandomShape().Type, StructureType = GetRandomStructure().Type };
